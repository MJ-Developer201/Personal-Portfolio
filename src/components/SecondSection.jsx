        ...
        <div>
          <div className="card">
            <img
              ...
              style={{ maxWidth: "auto", maxWidth: "1000px" }}
              alt=""
            />
            <div className="card-body">
              <h5 className="card-title">Dire Ride </h5>
              <p className="card-text" style={{ maxWidth: "45ch" }}>
                A front-end car detailers website. My focus was on a polished,
                modern layout with smooth animations and an emphasis on clarity
                in content
              </p>
              <div
                style={{
          ...
          <div className="card">
            ...
            <div style={{}} className="card-body">
              ...
              <p className="card-text" style={{ maxWidth: "37ch" }}>
                A social media platform where you can create post, like &
                comment .Create your Profile & upload photos .Make new friends,
                post memories, and discover new horizons.
              </p>
              <div className="" style={{ display: "flex", gap: "1rem" }}>
                <a
                  style={{}}
                  href="https://nexconnet.com/"
                  className="btn btn-primary"
                  target="_blank"
                >
                  Live Site
        ...
        <div>
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text" style={{ maxWidth: "45ch" }}>
                A sophisticated art gallery website, where I've constructed an
                array of captivating artworks, showcasing my ability to blend
                design and coding .
              </p>
              <div
                style={{
