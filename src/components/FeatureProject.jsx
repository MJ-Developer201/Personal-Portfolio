        ...
        <div className="card" style={{ maxWidth: "650px", marginTop: "5rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={{ lineHeight: "1.7rem" }}>
              A ticket tracking system where users can easily create projects,
              assign tasks, and effectively manage critical issues within their
              application. 'Issue Hold' offers a simplified approach to core
              ticket tracking features."
            </p>
            <div className="" style={{ display: "flex", gap: "1rem" }}>
              <a
                style={{}}
                href="https://issuehold.com/"
